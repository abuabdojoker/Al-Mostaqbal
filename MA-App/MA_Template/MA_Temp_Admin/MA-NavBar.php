...
<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="/admin" class="logo"><i class="icon-magnet icon-c-logo"></i><span>Ub<i class="md md-album"></i>ld</span></a>
            <!-- Image Logo here -->
        ...
        <div class="container">
            <div class="">
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="dropdown top-menu-item-xs">
                        <a href="" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true"><img src="/MA_Images/avatar5.png" alt="user-img" class="img-circle"> </a>
                        <ul class="dropdown-menu">
                            <li><a href="/<?php //print Username By Session  ?>"><i class="ti-user m-r-10 text-custom"></i> الملف الشخصى</a></li>
                            <li><a href="javascript:void(0)"><i class="ti-settings m-r-10 text-custom"></i> الاعدادت</a></li>
                            <li><a href="javascript:void(0)"><i class="ti-lock m-r-10 text-custom"></i> قفل الشاشة</a></li>
                            <li class="divider"></li>
                            <li><a href="/auth/logout"><i class="ti-power-off m-r-10 text-danger"></i> تسجيل خرورج</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
